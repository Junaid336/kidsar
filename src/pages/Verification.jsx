 ...
 return   (
    <div className="flex items-center justify-center min-h-screen p-5 bg-transparent min-w-screen">
        <div className="max-w-xl p-6 text-center text-gray-800 bg-white shadow-xl lg:max-w-3xl rounded-3xl lg:p-12">
            <h3 className="text-5xl">Check Your Inbox!</h3>
            ...
            <svg
                ...
                >
                    ...
                    />
                    <rect y={5} width={15} height={2} rx={1} className='fill-indigo-900' />
                    <rect y={11} width={15} height={2} rx={1} className='fill-indigo-900' />
                    <rect y={8} width={6} height={2} rx={1} className='fill-indigo-900' />
                    <rect y={15} width={6} height={2} rx={1} className='fill-indigo-900' />
                    <rect x={8} y={8} width={6} height={2} rx={1} className='fill-indigo-900' />
                    <rect x={8} y={15} width={6} height={2} rx={1} className='fill-indigo-900' />
                    <defs>
                    <linearGradient
                        id="paint0_linear"
                        x1="16.9996"
                    ...
                    >
                        <stop stopColor="#26105c" />
                        <stop offset={1} stopColor="#03319c" />
                    </linearGradient>
                    </defs>
                </svg>
            </div>
            <p>We are glad, that you’re with us ? We’ve sent you a verification link to the email address mail@yourdomain.com.</p>
            <div className="mt-4">
                <Link to='/login'>
                    <button className="px-8 py-3 text-white bg-indigo-900 rounded-full">
                        Login
                    </button>
                </Link>
            </div>
